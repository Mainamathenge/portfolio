                    ...
                    <div className="hero-content-new fade-in">
                        ...
                        <div className="hero-left">
                            <div className="profile-image-container">
                                {/* Using standard img tag for now to avoid dealing with next/image width/height requirements immediately, can upgrade later */}
                                <img
                                    src="/speaker.jpeg"
                                    alt="Joseph Maina"
                        ...
                        <div className="hero-right">
                            <h1 className="welcome-title">Hello 👋<br />Welcome to my portfolio</h1>
